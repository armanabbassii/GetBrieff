...
function Conferences() {
  return (
    <section className="bg-[#f7fafc] text-center py-20 text-gray-800">
      ...
      <div className="mt-10 bg-white border border-gray-300 rounded-md p-6 mx-auto max-w-lg shadow-lg">
      ...
      <div className="mt-4">
        <Link
          to="/more-conferences"
          className="bg-yellow-400 px-4 py-2 rounded-md font-semibold text-black"
        >
